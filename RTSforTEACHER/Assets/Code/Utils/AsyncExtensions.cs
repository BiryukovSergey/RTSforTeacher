...
namespace Code.Utils
{
    public static class AsyncExtensions
    {
        ...
        public static async Task<TResult> WithCancellation<TResult>(this IAwaitable<TResult>
            originalTask, CancellationToken ct) => await WithCancellation(originalTask.AsTask(), ct);
    }
}